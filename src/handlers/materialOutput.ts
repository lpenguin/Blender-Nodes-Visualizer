...
export const MaterialOutputPlugin: TSLNodePlugin = {
  ...
  def: {
    ...
    inputs: [
      ...
      { id: 'roughnessNode', name: 'Roughness', type: 'float', defaultValue: 0.5 },
      { id: 'metalnessNode', name: 'Metalness', type: 'float', defaultValue: 0 },
      ...
      { id: 'opacityNode', name: 'Opacity', type: 'float', defaultValue: 1 },
